...
describe('modules and groups', function () {
  ...
  it('can skip cross origin package combo', function () {
    var uri = 'http://' + location.hostname + ':9999/src/loader/tests/specs/packages-groups';
    require.config({
      group: 'my',
      packages: {
        'pkg-a': {
    ...
    var js = c.js;
    expect(js[0].uri).to.be.equal('http://' + location.hostname + ':9999/src/loader/tests/specs/packages-groups/pkg-b/??b.js');
